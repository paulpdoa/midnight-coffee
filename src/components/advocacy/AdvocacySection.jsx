const AdvocacySection = () => {
    return (
        <section className="my-10 flex justify-center">
            <div className="w-[80%]">
               <div>
                    <h1 className="heading-color font-bold text-5xl">Advocacy</h1>
                    <p className="text-justify text-base mt-5">Midnight Coffee advocates for the upcycling of used coffee grounds to reduce environmental impact and promote sustainability. Our website raises awareness of innovative methods to repurpose used coffee grounds, transforming waste into valuable resources. Join us in making each cup count towards a greener future!</p>
